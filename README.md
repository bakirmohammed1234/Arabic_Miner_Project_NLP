...
### **Note :**  In the first version, the project was implemented entirely in Java. However, I encountered some challenges finding suitable libraries to perform stemming (racinisation).
